...
[![CI](https://img.shields.io/github/actions/workflow/status/YOUR_HANDLE/fastemporal/ci.yml?label=CI&style=flat-square)](https://github.com/YOUR_HANDLE/fastemporal/actions)
